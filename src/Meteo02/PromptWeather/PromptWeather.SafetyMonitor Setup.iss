...
; Generated by Eduardo Maureira on 6/1/2012 (UTC)
;
[Setup]
AppName=ASCOM PromptWeather.SafetyMonitor Switches Driver
AppVerName=ASCOM PromptWeather.SafetyMonitor Switches Driver 0.81
AppVersion=0.1
...
OutputDir="."
OutputBaseFilename="PromptWeather.SafetyMonitor Setup"
Compression=lzma
...
UninstallFilesDir="{cf}\ASCOM\Uninstall\Switches\PromptWeather.SafetyMonitor"

[Languages]
Name: "english"; MessagesFile: "compiler:Default.isl"

[Dirs]
Name: "{cf}\ASCOM\Uninstall\Switches\PromptWeather.SafetyMonitor"
...
Filename: "{dotnet2032}\regasm.exe"; Parameters: "/codebase ""{app}\ASCOM.PromptWeather.SafetyMonitor.dll"""; Flags: runhidden 32bit
Filename: "{dotnet2064}\regasm.exe"; Parameters: "/codebase ""{app}\ASCOM.PromptWeather.SafetyMonitor.dll"""; Flags: runhidden 64bit; Check: IsWin64
...
[UninstallRun]
; Only for .NET assembly/in-proc drivers
Filename: "{dotnet2032}\regasm.exe"; Parameters: "-u ""{app}\ASCOM.PromptWeather.SafetyMonitor.dll"""; Flags: runhidden 32bit
Filename: "{dotnet2064}\regasm.exe"; Parameters: "-u ""{app}\ASCOM.PromptWeather.SafetyMonitor.dll"""; Flags: runhidden 64bit; Check: IsWin64
