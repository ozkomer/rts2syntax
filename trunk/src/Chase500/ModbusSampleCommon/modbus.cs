...
namespace ModbusTCP
{
    ...
    public class Master
    {
        ...
        public void ReadCoils(ushort id, ushort startAddress, ushort numInputs)
        {
        ...
        /// <param name="startAddress">Address from where the data read begins.</param>
        /// <param name="numInputs">Length of data.</param>
        public void ReadDiscreteInputs(ushort id, ushort startAddress, ushort numInputs)
        {
        ...
        /// <param name="startAddress">Address from where the data read begins.</param>
        /// <param name="numInputs">Length of data.</param>
        public void ReadHoldingRegister(ushort id, ushort startAddress, ushort numInputs)
        {
        ...
        /// <param name="startAddress">Address from where the data read begins.</param>
        /// <param name="numInputs">Length of data.</param>
        public void ReadInputRegister(ushort id, ushort startAddress, ushort numInputs)
        {
        ...
        public void WriteSingleCoils(ushort id, ushort startAddress, bool OnOff)
        {
            byte[] data;
        ...
        public void WriteMultipleCoils(ushort id, ushort startAddress, ushort numBits, byte[] values)
        {
        ...
        public void WriteSingleRegister(ushort id, ushort startAddress, byte[] values)
        {
            byte[] data;
        ...
        /// <param name="startAddress">Address to where the data is written.</param>
        /// <param name="values">Contains the register information.</param>
        public void WriteMultipleRegister(ushort id, ushort startAddress, byte[] values)
        {
        ...
        /// <param name="values">Contains the register information.</param>
        public void ReadWriteMultipleRegister(ushort id, ushort startReadAddress, ushort numInputs, ushort startWriteAddress, byte[] values)
        {
            ushort numBytes = Convert.ToUInt16(values.Length);
            if (numBytes % 2 > 0) numBytes++;
            byte[] data;
