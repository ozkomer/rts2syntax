...
; Generated by Eduardo Maureira on 2/1/2012 (UTC)
;
[Setup]
AppName=ASCOM Chase500 Dome Driver
AppVerName=ASCOM Chase500 Dome Driver 0.74
AppVersion=0.5
...
OutputDir="."
OutputBaseFilename="Chase500 Setup"
Compression=lzma
...
UninstallFilesDir="{cf}\ASCOM\Uninstall\Dome\Chase500"

[Languages]
Name: "english"; MessagesFile: "compiler:Default.isl"

[Dirs]
Name: "{cf}\ASCOM\Uninstall\Dome\Chase500"
...
Filename: "{dotnet2032}\regasm.exe"; Parameters: "/codebase ""{app}\ASCOM.Chase500.Dome.dll"""; Flags: runhidden 32bit
Filename: "{dotnet2064}\regasm.exe"; Parameters: "/codebase ""{app}\ASCOM.Chase500.Dome.dll"""; Flags: runhidden 64bit; Check: IsWin64
...
[UninstallRun]
; Only for .NET assembly/in-proc drivers
Filename: "{dotnet2032}\regasm.exe"; Parameters: "-u ""{app}\ASCOM.Chase500.Dome.dll"""; Flags: runhidden 32bit
Filename: "{dotnet2064}\regasm.exe"; Parameters: "-u ""{app}\ASCOM.Chase500.Dome.dll"""; Flags: runhidden 64bit; Check: IsWin64
